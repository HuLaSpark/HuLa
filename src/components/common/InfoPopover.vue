            ...
            <n-tooltip v-if="groupStore.getUserInfo(uid)?.linkedGitee">
              <template #trigger>
                <svg
                  ...
                  fill="#C71D23">
                  <path
                    d="M512 1024C230.4 1024 0 793.6 0 512S230.4 0 512 0s512 230.4 512 512-230.4 512-512 512z m259.2-569.6H480c-13.6 0-25.6 12-25.6 25.6v64c0 13.6 12 25.6 25.6 25.6h176c13.6 0 25.6 12 25.6 25.6v12.8c0 13.6-12 25.6-25.6 25.6H480c-13.6 0-25.6 12-25.6 25.6v64c0 13.6 12 25.6 25.6 25.6h291.2c13.6 0 25.6-12 25.6-25.6V480c0-13.6-12-25.6-25.6-25.6z m0-224H480c-13.6 0-25.6 12-25.6 25.6v64c0 13.6 12 25.6 25.6 25.6h291.2c13.6 0 25.6-12 25.6-25.6V256c0-13.6-12-25.6-25.6-25.6zM323.2 230.4H240c-13.6 0-25.6 12-25.6 25.6v512c0 13.6 12 25.6 25.6 25.6h83.2c13.6 0 25.6-12 25.6-25.6V256c0-13.6-12-25.6-25.6-25.6z"></path>
                </svg>
              </template>
              已绑定 Gitee
            </n-tooltip>
            <n-tooltip v-if="groupStore.getUserInfo(uid)?.linkedGithub">
              <template #trigger>
                <svg
                  ...
                  height="200">
                  <path
                    d="M512 12.672c-282.88 0-512 229.248-512 512 0 226.261333 146.688 418.133333 350.08 485.76 25.6 4.8 34.986667-11.114667 34.986667-24.618667 0-12.16-0.426667-52.544-0.64-95.082666C242.112 921.6 212.053333 823.146667 212.053333 823.146667c-23.253333-59.050667-56.746667-74.752-56.746666-74.752-46.506667-31.786667 3.52-31.146667 3.52-31.146667 51.413333 3.626667 78.506667 52.778667 78.506666 52.778667 45.674667 78.293333 119.893333 55.68 149.12 42.581333 4.608-33.109333 17.92-55.68 32.597334-68.48-113.664-12.8-233.216-56.832-233.216-253.013333 0-55.893333 19.968-101.546667 52.693333-137.386667-5.290667-12.885333-22.848-64.981333 5.013334-135.509333 0 0 42.986667-13.76 140.8 52.48 40.832-11.349333 84.629333-17.024 128.170666-17.237333 43.498667 0.213333 87.296 5.888 128.256 17.237333 97.728-66.24 140.650667-52.48 140.650667-52.48 27.946667 70.528 10.389333 122.624 5.12 135.509333 32.810667 35.84 52.629333 81.493333 52.629333 137.386667 0 196.693333-119.722667 239.957333-233.792 252.608 18.432 15.893333 34.794667 47.104 34.794667 94.912 0 68.501333-0.618667 123.648-0.618667 140.501333 0 13.653333 9.322667 29.610667 35.2 24.533334C877.44 919.573333 1024 727.616 1024 512c0-282.752-229.248-512-512-512z"
                    fill="#000000"
                    p-id="1461"></path>
                </svg>
              </template>
